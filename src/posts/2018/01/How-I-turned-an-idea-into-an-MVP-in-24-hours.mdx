...
date: 2018-01-15
tags: ["mvp", "product", "no code"]
featuredImage: editing-made-with-spark.png
embeddedImages:
  - carrd-starting-point.png
  - editing-made-with-spark.png
  - control-view-of-carrd.png
  - carrd__airtable.png
  - carrd__zapier-resp.png
---

## How I turned an idea into an MVP in 24 hours — Making of MadeWithSpark.com
...
just a few of the various templates you can use to start building with www.carrd.co.

<Img fluid={props.embedded.image2.fluid} />
Made With Spark’s homepage, as seen in the editing view of Carrd.
